...
coast_poly = Polygon(geo.COASTLINE, closed=True, facecolor=LAND,
                     edgecolor="#6B6B5E", linewidth=0.8, zorder=2)
...
ax.plot(hd_x, hd_y, color="#4A4A4A", linewidth=2.0, zorder=4,
        solid_capstyle="round")

plot_streets(ax, geo,
             color_major="#4A4A4A", color_medium="#7A7A7A", color_minor="#AAAAAA",
             lw_major=1.3, lw_medium=0.45, lw_minor=0.15)
...
ax.plot(*geo.PIN, marker="v", color="#CC3333", markersize=13, zorder=10)
